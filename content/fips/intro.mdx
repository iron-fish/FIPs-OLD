...
description: What are FIPs, how to use and get started with them.
---
...
Once your idea is well formulated, and you’re ready to write an improvement proposal, please first read [FIP-0](./fip-0) and use it as a starting point. Once you have your draft, please make a pull request (PR) to the [FIP repository](https://github.com/iron-fish/FIPs).
